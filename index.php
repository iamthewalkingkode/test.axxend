...
<head>
    ...
    <base href="http://localhost/axxend/" />
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            <section class="content">
                <form autocomplete="off" enctype="multipart/form-data" method="post" accept-charset="utf-8" action="" name="fayasms" id="fayasms">
                    <?php $alert::alertMsg($msg, $status);
                    if ($action) {
                        require('pages' . DS . $action . '.php');
                    } else {
                        require('pages' . DS . 'dashboard.php');
                    }
                    ?>
                </form>
            </section>
